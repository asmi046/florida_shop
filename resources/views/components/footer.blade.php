<footer>
    <div class="_wrapper">
        ...
        <div class="policy_line">
            <br />
            <a href="{{ route('policy') }}">Политика в области обработки конфиденциальной информации и персональных
                данных</a> и <a href="{{ route('policy_accept') }}">Согласие на обработку персональных данных</a>
            <br />
            <br />
            <a href="{{ route('cookie') }}">Политика использования файлов cookie</a>
            <br />
            <br />
            <a href="{{ route('review_consent') }}">Согласие на публикацию отзывов</a>
            <br />
            <br />
            <p>Индивидуальным предпринимателем Арепьев И.М. (Флорида)</p><br />
            <p>Курская область, Курский район, д. Зорино, ул. Пески д. 13</p><br />
            <a href="tel:{{ str_replace(['-', ' ', '(', ')'], '', $options['phone']) }}"
                class="phone">{{ $options['phone'] }}</a><br />
        </div>
    </div>
