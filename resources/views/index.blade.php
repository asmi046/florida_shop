...
@php
    $title = 'Доставка цветов в Курске недорого — Купить букет';
    $description =
        'Заказать цветы с доставкой по Курску.  Свежие букеты, авторская флористика. Бесплатная открытка к заказу, фото перед отправкой. Круглосуточно!';
@endphp
