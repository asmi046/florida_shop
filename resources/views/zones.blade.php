    ...
    <div class="_wrapper">
        <div class="text_blk">
            <h2>Способы оплаты</h2>
                ...
                <p>
                    <strong>Наличьный расчет</strong> осуществляется только при приобретении букетов вточке продаж.
                </p>
            <h2>Возврат</h2>
            <p>
                Возврт букетов и живых цветов осуществляется в течение 24 часов с момента покупки и исключительно в случае доставки товара ненадлежащего качества. При приобретении указанных выше товаров в точьке продаж обмен и возврат не осуществлется.
            </p>
