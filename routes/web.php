...
Route::get('/cookie', [EasyPageController::class, 'show_cookie_policy'])->name('cookie');
Route::get('/review_consent', [EasyPageController::class, 'show_review_consent'])->name('review_consent');
